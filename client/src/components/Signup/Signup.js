            ...
            2xl:w-[28%]">
                ...
                md:text-2xl'>
                    ...
                    <div className='mb-14 w-[90%]'>
                        {/* Password Section  */}
                        <input type="text" name="password" placeholder='Password' onChange={onChange} className='w-full bg-transparent border-b-[0.7px] pb-3 pl-2 focus:outline-none focus:border-b-2 focus:border-[#1AA2D9]' required />
                    </div>
                    <div className='mb-14 w-[90%]'>
                        {/* Password Section  */}
                        <input type="text" name="conPassword" placeholder='Confirm Password' onChange={onChange} className='w-full bg-transparent border-b-[0.7px] pb-3 pl-2 focus:outline-none focus:border-b-2 focus:border-[#1AA2D9]' required />
                    </div>
